            ...
            <div className="relative z-20 bg-black">
                <div className="container mx-auto max-w-4xl py-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 ">
                        ...
                        <p>
                            In 2015 he went on to do a Game Making & VFX BA at Digital Media at the ULHT in Lisbon. During this time
                            he started studying violin with Philip Xiao, New York Philharmonic Orchestra, and film music with
                            Christopher Young, and film theory with Michael Levine at the Berklee College of Music in.
                        </p>
                        <p>
                            Then he started to work as a game composition in Portugal with Mauricio Ponté and Roberto Neto and to
                            study at the Royal College of Music in London. He has been working as a composer and orchestrator across
                            Portugal and abroad. He has had his works performed throughout Europe and has collaborated with many
                            outstanding young soloists and with contemporary composers.
                        </p>
                    </div>
